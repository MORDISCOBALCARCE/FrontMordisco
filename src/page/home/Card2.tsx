...
//PROVISORIOOOOOOO. HAY QUE ELIMINAR 

interface Props {
    producto: Producto
}

export function Card2({ producto }: Props) {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-transparent hover:border-primary/20 flex flex-col h-full">
            <div className="h-48 overflow-hidden relative">
                <img alt={producto.titulo} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src={`${producto.imagen}`} />
